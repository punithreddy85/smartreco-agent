...
CATALOG: dict[str, list[dict]] = {
    "Agentic AI": [
        ("Agentic AI Foundations", "beginner",
        ...
        ("Building Multi-Agent Systems", "intermediate",
        ...
        ("Advanced Agentic Workflows with LangGraph", "advanced",
        ...
        ("Tool-Calling and Function Execution for Agents", "intermediate",
         ...
         ["agents", "tool-use", "llm"]),
        ("Agent Observability and Evaluation", "advanced",
        ...
        ("Autonomous Research Agents", "advanced",
    ...
    "LLM Engineering": [
        ...
        ("Fine-Tuning Open-Source LLMs", "advanced",
         ...
         ["llm", "fine-tuning"]),
        ("Structured Output and JSON-Schema Constrained Generation", "intermediate",
        ...
        ("Evaluating LLM Outputs at Scale", "intermediate",
         "Automated eval pipelines: LLM-as-judge, golden datasets, and regression testing for "
         "non-deterministic systems.",
         ["llm", "evals"]),
    ],
    "RAG & Retrieval": [
        ("Retrieval-Augmented Generation from Scratch", "beginner",
        ...
        ("Vector Databases in Depth", "intermediate",
        ...
        ("Advanced Retrieval: Reranking and Query Expansion", "advanced",
         ...
         ["rag", "reranking", "mmr"]),
        ("Hybrid Search: Combining Keyword and Semantic Retrieval", "intermediate",
         "Blend BM25 keyword search with dense vector search using score fusion, and know "
         "when each one wins.",
         ["rag", "hybrid-search"]),
        ("Grounding and Hallucination Prevention", "advanced",
    ...
    "Data Engineering": [
        ...
        ("The Transactional Outbox Pattern", "advanced",
    ...
    "Machine Learning": [
        ...
        ("Feature Engineering for Tabular Data", "intermediate",
        ...
        ("MLOps: Deploying Models to Production", "advanced",
         "Model registries, canary rollouts, and monitoring for drift once a model is live.",
         ["mlops", "deployment"]),
    ],
    "Cloud & DevOps": [
        ("Cloud Fundamentals: AWS, GCP, and Azure", "beginner",
        ...
        ("Infrastructure as Code with Terraform", "intermediate",
    ...
    "Product & Design": [
        ("Product Management Foundations", "beginner",
         ...
         "actually build from.",
         ["product-management"]),
        ("UX Research Methods", "intermediate",
         "Run usability tests, synthesize findings, and turn qualitative signal into design "
         "decisions.",
         ["ux", "research"]),
        ("Designing Persuasive User Experiences", "intermediate",
        ...
        ("Data-Informed Product Decisions", "advanced",
...
async def _seed_users() -> None:
    if not await catalog.get_user_by_email(ADMIN_EMAIL):
        await catalog.create_user(ADMIN_EMAIL, hash_password(ADMIN_PASSWORD), role="admin")
