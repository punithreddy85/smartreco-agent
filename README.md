...
[![Tests](https://github.com/punithreddy85/smartreco-agent/actions/workflows/test.yml/badge.svg)](https://github.com/punithreddy85/smartreco-agent/actions/workflows/test.yml)
[![Coverage](https://codecov.io/gh/punithreddy85/smartreco-agent/branch/main/graph/badge.svg)](https://codecov.io/gh/punithreddy85/smartreco-agent)
[![License: Apache 2.0](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)

A production-ready AI agent with streaming capabilities, conversation management, and enterprise-grade features.
...
- **Multiple Client Examples**: Python async and Streamlit demo applications
...
The SmartReco Agent now features a simplified streaming API that makes client integration easier while preserving all enterprise features:
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/punithreddy85/smartreco-agent.git
   cd smartreco-agent
   ```
...
5. **Run the application**
   ```bash
   uv run python -m smartreco_agent.src.main
   ```
...
# Response: {"status": "healthy", "service": "SmartReco Agent"}
```
...
# Run with coverage
pytest --cov=smartreco_agent.src --cov-report=html
...
- **Scaling**: Run multiple container instances behind a load balancer as needed
...
- **Issues**: [GitHub Issues](https://github.com/punithreddy85/smartreco-agent/issues)
...
**Built with ❤️ by [punithreddy85](https://github.com/punithreddy85)**
