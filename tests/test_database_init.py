...
from smartreco_agent.src.core.exceptions.exceptions import AppException
...
class TestDatabaseInitialization:
    ...
    async def test_initialize_database_skips_when_inmemory(self):
        ...
        with patch("smartreco_agent.src.core.agent.settings") as mock_settings:
    ...
    async def test_initialize_database_calls_setup(self):
        ...
        with patch("smartreco_agent.src.core.agent.settings") as mock_settings:
            ...
            with patch(
                "smartreco_agent.src.core.agent.AsyncPostgresSaver.from_conn_string",
