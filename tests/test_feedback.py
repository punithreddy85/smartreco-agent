...
from smartreco_agent.src.routes.feedback import router
from smartreco_agent.src.schema import FeedbackRequest


class TestFeedbackRoute:
    """Test cases for feedback endpoint."""

    @patch("smartreco_agent.src.routes.feedback.client")
