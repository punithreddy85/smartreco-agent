"""History route for the SmartReco Agent API.
...
from smartreco_agent.src.core.agent_utils import langchain_to_chat_message
from smartreco_agent.src.core.storage import get_shared_checkpointer
from smartreco_agent.src.schema import ChatHistoryResponse, ChatMessage, ToolCall
