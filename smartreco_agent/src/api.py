"""FastAPI server implementation for the SmartReco Agent.
...
management for the SmartReco Agent service.
"""
...
from smartreco_agent.src.routes.stream import router as stream_router
from smartreco_agent.src.routes.threads import router as threads_router
