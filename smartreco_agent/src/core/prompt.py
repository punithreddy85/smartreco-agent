"""System prompts and prompt utilities for the SmartReco Agent.

This module contains the system prompts and related utilities used by the
SmartReco Agent to provide consistent behavior and instructions.
"""
...
def get_system_prompt() -> str:
    """Get the main system prompt for the SmartReco Agent.
    ...
    return (
        f"You are SmartReco Agent, a powerful and helpful assistant with the ability to use specialized tools.\n\n"
