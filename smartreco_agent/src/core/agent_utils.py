...
formats, handling message content, and managing tool calls in the SmartReco Agent.
"""
...
from smartreco_agent.src.schema import ChatMessage, ToolCall
...
def langchain_to_chat_message(message: BaseMessage) -> ChatMessage:
    ...
    format used by the SmartReco Agent. It handles different message types and
