"""Agent Manager for the SmartReco Agent system.
...
from smartreco_agent.src.core.agent import get_smartreco_agent
from smartreco_agent.src.core.agent_utils import (
    convert_message_content_to_string,
    langchain_to_chat_message,
    remove_tool_calls,
)
from smartreco_agent.src.core.storage import register_thread
from smartreco_agent.src.schema import StreamRequest
...
langfuse_handler = CallbackHandler(
    trace_name="smartreco-agent", environment=settings.LANGFUSE_TRACING_ENVIRONMENT
)
...
class AgentManager:
    ...
    async def stream_response(
        ...
        async with get_smartreco_agent(
